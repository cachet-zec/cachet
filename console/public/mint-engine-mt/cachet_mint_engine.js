/* @ts-self-types="./cachet_mint_engine.d.ts" */
 ...
 * @param {boolean} first_issuance
 * @param {number} target_height
 * @returns {any}
 */
export function build_issuance_tx(seed_phrase, description, amount, finalize, first_issuance, target_height) {
    ...
    const ret = wasm.build_issuance_tx(ptr0, len0, ptr1, len1, amount, finalize, first_issuance, target_height);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function issuer_info(seed_phrase, description) {
    const ptr0 = passStringToWasm0(seed_phrase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(description, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.issuer_info(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function wallet_reset(seed_phrase) {
    const ptr0 = passStringToWasm0(seed_phrase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.wallet_reset(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function wallet_scan(seed_phrase, blocks) {
    const ptr0 = passStringToWasm0(seed_phrase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.wallet_scan(ptr0, len0, blocks);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports(memory) {
    const import0 = {
        ...
        memory: memory || new WebAssembly.Memory({initial:27,maximum:32768,shared:true}),
    };
    return {
        __proto__: null,
        "./cachet_mint_engine_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cachet_mint_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports(memory);
